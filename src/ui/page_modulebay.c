...
static lv_coord_t col_dsc[] = {160, 200, 200, 200, 200, 200, LV_GRID_TEMPLATE_LAST};
...
static lv_obj_t *page_create(lv_obj_t *parent, panel_arr_t *arr) {
    ...
    // create menu entries
    create_btn_group_item2(&btn_group_module_type, cont, 5, "Module Type", "Unknown", "Switch", "rapidFIRE", "Steadyview", "Steadyview-X", NULL, ROW_MODULE_TYPE);
